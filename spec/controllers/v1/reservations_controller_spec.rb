...
RSpec.describe V1::ReservationsController, type: :controller do
  ...
  # Reservation. As you add validations to V1::Reservation, be sure to
  ...
  # V1::ReservationsController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe 'POST #create' do
    context 'with valid params' do
      it 'creates a new V1::Reservation' do
        expect do
          post :create, params: { reservation: valid_attributes }, session: valid_session
        end.to change(V1::Reservation, :count).by(1)
      end
